                        ...
                        <div class="card-body p-4">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="full_name"
                                        class="col-form-label text-md-end">{{ __('Full name') }}</label>

                                    <input id="full_name" type="text"
                                        class="form-control @error('full_name') is-invalid @enderror" name="full_name"
                                        value="{{ old('full_name') }}" required autocomplete="off" autofocus>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input id="contact_number" type="number"
                                        ...
                                        autocomplete="contact_number" maxlength="11" autofocus>
                                ...
                                <div class="col-md-12 mt-4">
                                    <button class="btn btn-primary w-100 p-2 mb-4">Register</button>
